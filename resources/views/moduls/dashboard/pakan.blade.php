                            ...
                            <div class="sm:flex items-center justify-start gap-2">
                                <button onclick="toggleModal('modal-id')" type="button"
                                    ...
                                    <p class=" font-semibold leading-none text-white flex items-center gap-1"><i
                                            class='bx bx-plus text-lg'></i><span>Tambah Pakan</span></p>
                                </button>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($pakans as $pakan)
                                    <tr class="data-consume">
                                        ...
                                        <td class="flex gap-2">
                                            <a href="{{ route('pakan.edit', $pakan->id) }}"
                                                class="focus:ring-2 focus:ring-offset-2 mt-4 sm:mt-0 inline-flex items-start justify-start p-3 bg-primary hover:bg-primary focus:outline-none rounded">
                        ...
                        <div class="flex gap-1">
                            <div class="mb-1 pt-0 w-full">
                                <label for="" class="text-blueGray-600 text-base font-medium">Kode
                                    Alternatif</label>
                                <input name="kode_alternatif" type="text" placeholder="Kode Alternatif"
                            ...
                            <div class="mb-1 pt-0 w-full">
                                ...
                                <input name="jenis_pakan" type="text" placeholder="Nama Pakan"
                                    class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full" />
                            </div>
                        </div>
