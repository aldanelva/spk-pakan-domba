        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div class="relative p-6 flex-auto">
                <form action="{{ route('pakan.store') }}" class="flex flex-col gap-1" method="post">
                    ...
                    <div class="flex gap-1">
                        <div class="mb-1 pt-0 w-full">
                            <label for="serat" class="text-blueGray-600 text-base font-medium">Serat (%)</label>
                            <input name="serat" type="number" step="0.01" placeholder="Contoh: 23.98" class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full" />
                        </div>
                        <div class="mb-1 pt-0 w-full">
                            <label for="lemak" class="text-blueGray-600 text-base font-medium">Lemak (%)</label>
                            <input name="lemak" type="number" step="0.01" placeholder="Contoh: 23.98" class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full" />
                        </div>
                        <div class="mb-1 pt-0 w-full">
                            <label for="abu" class="text-blueGray-600 text-base font-medium">Abu (%)</label>
                            <input name="abu" type="number" step="0.01" placeholder="Contoh: 23.98" class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full" />
                        </div>
                        <div class="mb-1 pt-0 w-full">
                            <label for="protein" class="text-blueGray-600 text-base font-medium">Protein (%)</label>
                            <input name="protein" type="number" step="0.01" placeholder="Contoh: 23.98" class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full" />
                        </div>
                    </div>

                    <div class="flex gap-1">
                        <div class="mb-1 pt-0 w-full">
                            <label for="harga" class="text-blueGray-600 text-base font-medium">Harga</label>
                            <select name="harga" class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full">
                        ...
                        <div class="mb-1 pt-0 w-full">
                            <label for="jarak" class="text-blueGray-600 text-base font-medium">Jarak</label>
                            <select name="jarak" class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full">
                        ...
                        <div class="mb-1 pt-0 w-full">
                            <label for="ketersediaan" class="text-blueGray-600 text-base font-medium">Ketersediaan</label>
                            <select name="ketersediaan" class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full">
                                <option value="Cukup">Cukup</option>
