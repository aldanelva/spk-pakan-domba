                                ...
                                <div class="flex flex-col gap-1 ml-6">
                                    ...
                                    <div class="sm:flex items-center justify-start gap-2">
                                        ...
                                        <button onclick="toggleModal2('modal-id2')" type="button"
                                            class="focus:ring-2 focus:ring-offset-2  mt-4 sm:mt-0 inline-flex items-start justify-start px-6 py-1 bg-primary hover:bg-primary focus:outline-none rounded">
                                            <p class=" font-semibold leading-none text-white flex items-center gap-1"><i
                                                    class='bx bxs-bar-chart-alt-2 text-lg'></i></i><span>Generate
                                                    Ranking</span></p>
                                        </button>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($penilaians as $penilaian)
                                            <tr class="data-consume">
                                                ...
                                                <td class="flex gap-2">
                                                    <a href="/penilaian/user/manual/edit/{{ $penilaian['id'] }}"
                    ...
                    <form action="{{ route('penilaian.user.update', ['id' => $penilaian->id]) }}"
                        ...
                        <div
                            ...
                            <button
                                ...
                                type="button" onclick="toggleModal('modal-id3')">
                                Close
                            </button>
                            <button type="submit"
    ...
    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center"
        ...
        <div class="relative w-auto my-6 mx-auto max-w-3xl">
            ...
            <div
                ...
                <!--body-->
                <div class="relative p-6 flex-auto">
                    <form action="{{ route('penilaian.user.store') }}" class="flex flex-col w-full gap-1"
                        method="post">
                        @csrf
