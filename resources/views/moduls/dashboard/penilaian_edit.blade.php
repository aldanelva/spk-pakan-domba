...
e                           x-col gap-1">
                        ...
                        <div class="sm:flex items-center justify-start gap-2">
                            ...
                            <button onclick="toggleModal('modal-id')" type="button" class="focus:ring-2 focu
                          s             :ring-offset-2  mt-4 sm:mt-0 inline-flex items-start justify-start px-6 py-1 bg-primary hover:bg-primary focus:outline-none rounded">
                            ...
                            <button onclick="toggleModal2('modal-id2')" type="button" class="focus:ring-2 fo
                ...
                <div class="overflow-x-auto w-full min-w-full box bg-white p-8 rounded-lg">
                    ...
                    <table class="display w-full example" style="width:100%">
                        ...
                        <tbody>
                            ...
                            @php
                            $penilaian = $penilaian_for_kedekatan_relatif->firstWhere('kode_alternatif', $kode_alternatif);
                            @endphp
                            @if ($penilaian)
                            <tr class="data-consume">
                                <td>{{ $i }}</td>
    ...
    <div class="relative w-auto my-6 mx-auto max-w-3xl">
        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div class="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
                ...
                <button c l ass="p-1 ml-auto bg-transparent border-0 text-black opacity-5 float-right text-3xl leading-none font-semibold outline-none focus:outline-none" onclick="toggleModal('modal-id')">
            ...
            <div class="relative p-6 flex-auto">
                <form action="{{ route('penilaian.store') }}" class="flex flex-col w-full gap-1" method="post">
                    ...
                    <div class="mb-1 pt-0 w-full">
                        <label for="" class="text-blueGray-6
